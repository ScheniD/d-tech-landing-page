document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        de: {
            ...
            localServiceTitle: "Praxen & Kanzleien",
            localServiceDesc: "Eine repräsentative und vertrauensbildende Webpräsenz für Praxen, Kanzleien und anspruchsvolle Dienstleister. Die nahtlos integrierte Online-Terminbuchung entlastet Ihr Team spürbar im Arbeitsalltag.",
            localBusinessTitle: "Kleine & mittlere Unternehmen",
            localBusinessDesc: "Ein moderner, maßgeschneiderter Webauftritt, der die Qualität Ihres Handwerks oder Fachbetriebs optimal zur Geltung bringt. Digitale Anfrageprozesse gewinnen Neukunden und sparen wertvolle Zeit.",
            localSEOTitle: "Regionale Sichtbarkeit (SEO)",
            localSEODesc: "Zielgerichtete Optimierung für Suchmaschinen und Google Maps. Sorgen Sie dafür, dass Interessenten in Ihrer Region Ihre Dienstleistungen direkt finden, wenn sie danach suchen.",
            trustTitle: "Akademische Expertise & Transparenz",
        ...
        en: {
            ...
            localServiceTitle: "Practices & Law Firms",
            localServiceDesc: "A prestigious, trust-building web presence for medical practices, law firms, and high-end service providers. Seamlessly integrated online booking noticeably reduces your team's administrative workload.",
            localBusinessTitle: "Small & Medium Enterprises",
            localBusinessDesc: "A modern, custom web presence that highlights the quality of your craft or specialized business. Structured digital inquiry processes attract new clients and save valuable time.",
            localSEOTitle: "Regional Visibility (SEO)",
            localSEODesc: "Targeted optimization for search engines and Google Maps, ensuring prospective clients in your region find your services instantly when searching for them.",
            trustTitle: "Academic Expertise & Transparency",
